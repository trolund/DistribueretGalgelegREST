...
@WebService(endpointInterface = "Galgeleg.RMI.SOAP.ISOAPGelgeleg")
public class SOAPGalgelogik implements ISOAPGelgeleg {
    ...
    public SOAPGalgelogik() throws java.rmi.RemoteException {
        muligeOrd.add("bil");
    ...
    public void hentOrdFraDr(){
        ...
        //System.out.println("Login.data = " + Login.data);
        ...
        System.out.println("Login.data = " + Arrays.asList(data.split("\\s+")));
        muligeOrd.clear();
